...
public class OdmaStaticSystemClassDataContentElement extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassDataContentElement(OdmaStaticSystemClass superClass, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
        super(subClasses);
