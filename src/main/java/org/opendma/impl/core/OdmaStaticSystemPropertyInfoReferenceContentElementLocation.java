...
public class OdmaStaticSystemPropertyInfoReferenceContentElementLocation extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoReferenceContentElementLocation() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_LOCATION.getNamespace(),OdmaType.STRING,false,true));
