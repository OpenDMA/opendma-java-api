...
public class OdmaStaticSystemPropertyInfoContainerTitle extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoContainerTitle() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_TITLE.getNamespace(),OdmaType.STRING,false,true));
