...
public class OdmaStaticSystemPropertyInfoChoiceValueShortValue extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoChoiceValueShortValue() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_SHORTVALUE.getNamespace(),OdmaType.STRING,false,true));
