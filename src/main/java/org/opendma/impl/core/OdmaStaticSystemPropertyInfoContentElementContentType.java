...
public class OdmaStaticSystemPropertyInfoContentElementContentType extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoContentElementContentType() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_CONTENTTYPE.getNamespace(),OdmaType.STRING,false,true));
