...
public class OdmaStaticSystemClassAuditStamped extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassAuditStamped(OdmaStaticSystemClass superClass, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
        super(subClasses);
