...
public class OdmaStaticSystemPropertyInfoClassDeclaredProperties extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoClassDeclaredProperties() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_DECLAREDPROPERTIES.getNamespace(),OdmaType.STRING,false,true));
