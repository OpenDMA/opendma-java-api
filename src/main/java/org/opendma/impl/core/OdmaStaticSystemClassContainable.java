...
public class OdmaStaticSystemClassContainable extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassContainable(OdmaStaticSystemClass superClass, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
        super(subClasses);
