...
public class OdmaStaticSystemPropertyInfoDocumentVersion extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoDocumentVersion() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_VERSION.getNamespace(),OdmaType.STRING,false,true));
