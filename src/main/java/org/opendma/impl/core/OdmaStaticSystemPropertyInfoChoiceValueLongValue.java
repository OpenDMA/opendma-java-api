...
public class OdmaStaticSystemPropertyInfoChoiceValueLongValue extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoChoiceValueLongValue() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_LONGVALUE.getNamespace(),OdmaType.STRING,false,true));
