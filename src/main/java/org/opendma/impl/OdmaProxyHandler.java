...
public class OdmaProxyHandler implements InvocationHandler {
    ...
    static {
        ...
        PROPERTY_MAP.put("getIntegerValue", new PropertyMapping(OdmaCommonNames.PROPERTY_INTEGERVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("setIntegerValue", new PropertyMapping(OdmaCommonNames.PROPERTY_INTEGERVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("getShortValue", new PropertyMapping(OdmaCommonNames.PROPERTY_SHORTVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("setShortValue", new PropertyMapping(OdmaCommonNames.PROPERTY_SHORTVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("getLongValue", new PropertyMapping(OdmaCommonNames.PROPERTY_LONGVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("setLongValue", new PropertyMapping(OdmaCommonNames.PROPERTY_LONGVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("getFloatValue", new PropertyMapping(OdmaCommonNames.PROPERTY_FLOATVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("setFloatValue", new PropertyMapping(OdmaCommonNames.PROPERTY_FLOATVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("getDoubleValue", new PropertyMapping(OdmaCommonNames.PROPERTY_DOUBLEVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("setDoubleValue", new PropertyMapping(OdmaCommonNames.PROPERTY_DOUBLEVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("getBooleanValue", new PropertyMapping(OdmaCommonNames.PROPERTY_BOOLEANVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("setBooleanValue", new PropertyMapping(OdmaCommonNames.PROPERTY_BOOLEANVALUE, OdmaType.STRING, false));
        PROPERTY_MAP.put("getDateTimeValue", new PropertyMapping(OdmaCommonNames.PROPERTY_DATETIMEVALUE, OdmaType.STRING, false));
