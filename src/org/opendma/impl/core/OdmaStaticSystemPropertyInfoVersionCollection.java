...
public class OdmaStaticSystemPropertyInfoVersionCollection extends OdmaStaticSystemPropertyInfo
{
    ...
    {
        properties.put(OdmaTypes.PROPERTY_NAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAME,OdmaTypes.PROPERTY_VERSIONCOLLECTION.getName(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_NAMEQUALIFIER,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAMEQUALIFIER,OdmaTypes.PROPERTY_VERSIONCOLLECTION.getQualifier(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_DISPLAYNAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_DISPLAYNAME,OdmaTypes.PROPERTY_VERSIONCOLLECTION.getName(),OdmaTypes.TYPE_STRING,false,true));
