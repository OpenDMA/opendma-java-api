...
public class OdmaStaticSystemClassContainable extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassContainable(OdmaStaticSystemClass parent, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
