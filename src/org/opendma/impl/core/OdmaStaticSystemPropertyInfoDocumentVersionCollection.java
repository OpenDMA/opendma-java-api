...
public class OdmaStaticSystemPropertyInfoDocumentVersionCollection extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoDocumentVersionCollection() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_VERSIONCOLLECTION.getNamespace(),OdmaType.STRING,false,true));
