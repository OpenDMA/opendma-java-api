...
public class OdmaStaticSystemClassReferenceContentElement extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassReferenceContentElement(OdmaStaticSystemClass parent, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
