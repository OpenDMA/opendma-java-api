...
public class OdmaStaticSystemClassPropertyInfo extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassPropertyInfo(OdmaStaticSystemClass parent, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
