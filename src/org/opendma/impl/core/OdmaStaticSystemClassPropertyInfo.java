...
public class OdmaStaticSystemClassPropertyInfo extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassPropertyInfo(OdmaStaticSystemClass parent, OdmaClassEnumeration subClasses, OdmaClassEnumeration aspects, OdmaPropertyInfoEnumeration declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
        super(parent,subClasses);
        properties.put(OdmaTypes.PROPERTY_NAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAME,OdmaTypes.CLASS_PROPERTYINFO.getName(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_NAMEQUALIFIER,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAMEQUALIFIER,OdmaTypes.CLASS_PROPERTYINFO.getQualifier(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_DISPLAYNAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_DISPLAYNAME,OdmaTypes.CLASS_PROPERTYINFO.getName(),OdmaTypes.TYPE_STRING,false,true));
        ...
        properties.put(OdmaTypes.PROPERTY_ASPECT,new OdmaPropertyImpl(OdmaTypes.PROPERTY_ASPECT,Boolean.FALSE,OdmaTypes.TYPE_BOOLEAN,false,true));
        properties.put(OdmaTypes.PROPERTY_INSTANTIABLE,new OdmaPropertyImpl(OdmaTypes.PROPERTY_INSTANTIABLE,Boolean.TRUE,OdmaTypes.TYPE_BOOLEAN,false,true));
