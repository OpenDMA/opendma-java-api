...
public class OdmaStaticSystemClassPropertyInfo extends OdmaStaticSystemClass
{

    public OdmaStaticSystemClassPropertyInfo(OdmaStaticSystemClass superClass, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
        super(subClasses);
        properties.put(OdmaCommonNames.PROPERTY_NAME,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAME,OdmaCommonNames.CLASS_PROPERTYINFO.getName(),OdmaType.STRING,false,true));
        properties.put(OdmaCommonNames.PROPERTY_NAMEQUALIFIER,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMEQUALIFIER,OdmaCommonNames.CLASS_PROPERTYINFO.getQualifier(),OdmaType.STRING,false,true));
        properties.put(OdmaCommonNames.PROPERTY_DISPLAYNAME,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_DISPLAYNAME,OdmaCommonNames.CLASS_PROPERTYINFO.getName(),OdmaType.STRING,false,true));
        ...
        properties.put(OdmaCommonNames.PROPERTY_ASPECT,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_ASPECT,Boolean.FALSE,OdmaType.BOOLEAN,false,true));
        properties.put(OdmaCommonNames.PROPERTY_INSTANTIABLE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_INSTANTIABLE,Boolean.TRUE,OdmaType.BOOLEAN,false,true));
