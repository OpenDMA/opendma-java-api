...
public class OdmaStaticSystemClassRepository extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassRepository(OdmaStaticSystemClass parent, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
