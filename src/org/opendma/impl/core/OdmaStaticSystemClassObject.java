...
public class OdmaStaticSystemClassObject extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassObject(OdmaStaticSystemClass parent, OdmaClassEnumeration subClasses, OdmaClassEnumeration aspects, OdmaPropertyInfoEnumeration declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
