...
public class OdmaStaticSystemClassClass extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassClass(OdmaStaticSystemClass parent, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
