...
public class OdmaStaticSystemPropertyInfoRepositoryRootFolder extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoRepositoryRootFolder() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_ROOTFOLDER.getNamespace(),OdmaType.STRING,false,true));
