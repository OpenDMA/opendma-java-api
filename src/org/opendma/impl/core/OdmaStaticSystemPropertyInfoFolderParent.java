...
public class OdmaStaticSystemPropertyInfoFolderParent extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoFolderParent() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_PARENT.getNamespace(),OdmaType.STRING,false,true));
