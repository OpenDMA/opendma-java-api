...
public class OdmaStaticSystemPropertyInfoDocumentCheckedOutAt extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoDocumentCheckedOutAt() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_CHECKEDOUTAT.getNamespace(),OdmaType.STRING,false,true));
