...
public class OdmaStaticSystemPropertyInfoVersionCreatedBy extends OdmaStaticSystemPropertyInfo
{

    public OdmaStaticSystemPropertyInfoVersionCreatedBy() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
        properties.put(OdmaTypes.PROPERTY_NAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAME,OdmaTypes.PROPERTY_VERSIONCREATEDBY.getName(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_NAMEQUALIFIER,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAMEQUALIFIER,OdmaTypes.PROPERTY_VERSIONCREATEDBY.getQualifier(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_DISPLAYNAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_DISPLAYNAME,OdmaTypes.PROPERTY_VERSIONCREATEDBY.getName(),OdmaTypes.TYPE_STRING,false,true));
