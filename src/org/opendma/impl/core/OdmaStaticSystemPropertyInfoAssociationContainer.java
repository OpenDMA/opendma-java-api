...
public class OdmaStaticSystemPropertyInfoAssociationContainer extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoAssociationContainer() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_CONTAINER.getNamespace(),OdmaType.STRING,false,true));
