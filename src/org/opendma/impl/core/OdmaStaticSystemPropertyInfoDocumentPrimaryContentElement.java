...
public class OdmaStaticSystemPropertyInfoDocumentPrimaryContentElement extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoDocumentPrimaryContentElement() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_PRIMARYCONTENTELEMENT.getNamespace(),OdmaType.STRING,false,true));
