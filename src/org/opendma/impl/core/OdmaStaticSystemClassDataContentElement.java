...
public class OdmaStaticSystemClassDataContentElement extends OdmaStaticSystemClass
{
    ...
    public OdmaStaticSystemClassDataContentElement(OdmaStaticSystemClass parent, Iterable<OdmaClass> subClasses, Iterable<OdmaClass> aspects, Iterable<OdmaPropertyInfo> declaredProperties, boolean retrievable, boolean searchable) throws OdmaInvalidDataTypeException, OdmaAccessDeniedException
    {
