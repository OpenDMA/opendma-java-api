...
public class OdmaStaticSystemPropertyInfoReferenceValue extends OdmaStaticSystemPropertyInfo
{
    ...
    {
        properties.put(OdmaTypes.PROPERTY_NAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAME,OdmaTypes.PROPERTY_REFERENCEVALUE.getName(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_NAMEQUALIFIER,new OdmaPropertyImpl(OdmaTypes.PROPERTY_NAMEQUALIFIER,OdmaTypes.PROPERTY_REFERENCEVALUE.getQualifier(),OdmaTypes.TYPE_STRING,false,true));
        properties.put(OdmaTypes.PROPERTY_DISPLAYNAME,new OdmaPropertyImpl(OdmaTypes.PROPERTY_DISPLAYNAME,OdmaTypes.PROPERTY_REFERENCEVALUE.getName(),OdmaTypes.TYPE_STRING,false,true));
