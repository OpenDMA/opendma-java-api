...
public class OdmaStaticSystemPropertyInfoAssociationContainable extends OdmaStaticSystemPropertyInfo {
    ...
    public OdmaStaticSystemPropertyInfoAssociationContainable() throws OdmaInvalidDataTypeException, OdmaAccessDeniedException {
        ...
        properties.put(OdmaCommonNames.PROPERTY_NAMESPACE,new OdmaPropertyImpl(OdmaCommonNames.PROPERTY_NAMESPACE,OdmaCommonNames.PROPERTY_CONTAINABLE.getNamespace(),OdmaType.STRING,false,true));
