...
/**
 * Exception thrown whenever an OpenDMA implementation is misconfigured and
 * unable to perform the action requested by the user.
 * 
...
public class OdmaConfigurationException extends Exception
{
    ...
    /**
     * Create a new <code>OdmaConfigurationException</code> with the given
     * parameters.
     * 
     * @param msg
