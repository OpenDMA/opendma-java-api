...
/**
 * Exception thrown whenever an OpenDMA implementation is unable to locate
 * an object requested by the user. This could be a class or property identified
 * by a qualified name or a Object identified by ID.<br>
...
public class OdmaObjectNotFoundException extends Exception
{
    ...
    /**
     * Create a new <code>OdmaObjectNotFoundException</code> with the given parameters.
     * 
     * @param unknownObject the qualified name of the object that could not be found
     */
     ...
     * Create a new <code>OdmaObjectNotFoundException</code> with the given parameters.
     * 
     * @param unknownId the ID of the object that could not be found
     */
