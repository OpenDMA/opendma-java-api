...
/**
 * Exception thrown whenever an OpenDMA implementation is unable to handle
 * a user request due to an internal failure.<br>
 * <b>This Exception may be thrown by any API method at any time.</b><br>
 * If the cause of this failure falls into one of the predefined categories
 * like object not found or access denied, the implementation has to throw
 * the corresponding OpenDMA Exception (e.g. <code>OdmaObjectNotFoundException</code>).<br>
 * 
...
public class OdmaEngineRuntimeException extends RuntimeException
{
    ...
    /**
     * Create a new <code>OdmaEngineRuntimeException</code> with the given parameters.
     * 
