 ...
 */
public interface OdmaContentElementEnumeration
{

    /**
     * Returns an iterator over all <code>OdmaContentElement</code> elements.
     * 
     * @return an iterator over all <code>OdmaContentElement</code> elements.
     */
