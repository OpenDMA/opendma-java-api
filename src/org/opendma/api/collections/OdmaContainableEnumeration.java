 ...
 */
public interface OdmaContainableEnumeration
{

    /**
     * Returns an iterator over all <code>OdmaContainable</code> elements.
     * 
     * @return an iterator over all <code>OdmaContainable</code> elements.
     */
