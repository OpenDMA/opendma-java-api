 ...
 */
public interface OdmaContainerEnumeration
{

    /**
     * Returns an iterator over all <code>OdmaContainer</code> elements.
     * 
     * @return an iterator over all <code>OdmaContainer</code> elements.
     */
